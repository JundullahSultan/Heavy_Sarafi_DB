  ...
  try {
    ...
    const customers = [
      {
        ...
        idImageUrl: "https://res.cloudinary.com/demo/image/upload/v123456/sample.jpg",
        branch: "Kabul Branch",
    ...
    const expenses = [
      {
        ...
        recordedBy: "kabul",
        branch: "Kabul Branch",
        receiptUrl: "https://res.cloudinary.com/demo/image/upload/v123456/sample.jpg"
      },
      {
        id: "EXP-002",
        date: "2026-07-06",
    ...
    const hawalas = [
      // Sent Hawalas
      {
        ...
        senderIdImageUrl: "https://res.cloudinary.com/demo/image/upload/v123456/sample.jpg",
        ...
        receiverIdImageUrl: "https://res.cloudinary.com/demo/image/upload/v123456/sample.jpg",
        amount: 2500,
        currency: "USD",
        fee: 10,
        status: "Pending",
